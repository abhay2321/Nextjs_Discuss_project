        ...
        <form action={action}>
          ...
          <div className="grid gap-4 py-4">
            <div>
              ...
              <Input id="title" name="title" className="focus-visible:ring-0"/>
            </div>
            {formState.errors.title && <p className="text-sm text-red-600">{formState.errors.title}</p>}
            <div>
              <Label htmlFor="content" className="text-right pb-1">
                Content
              </Label>
              <Textarea id="content" name="content" className="focus-visible:ring-0" />
            </div>
